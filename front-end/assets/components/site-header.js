class SiteHeader extends HTMLElement {
  ...
  render() {
    ...
    const avatarUrl = localStorage.getItem("userAvatar") || "assets/img/profile.jpg";
            ...
            isAuthed
              ? `
                <div class="profile-menu">
                  <button class="avatar-btn" type="button" aria-label="Profile menu">
    ...
    if (avatarBtn && logoutBtn) {
      avatarBtn.addEventListener("click", (e) => {
        e.stopPropagation();
        this.classList.toggle("profile-open");
      });
