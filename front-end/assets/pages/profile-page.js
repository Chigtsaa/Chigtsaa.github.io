  ...
  loadProfileData() {
    try {
      ...
      if (raw) {
        ...
        return {
          ...parsed,
          avatar: parsed.avatar || storedAvatar || 'assets/img/profile.jpg',
        };
      }
    } catch (err) {
    ...
    return {
      ...
      id: '23b1num0245',
      avatar: storedAvatar || 'assets/img/profile.jpg',
    };
  }
  ...
  attachModalHandlers() {
    ...
    if (form) {
      form.addEventListener('submit', (e) => {
        e.preventDefault();
        const avatarValue = form.avatar.value.trim() || 'assets/img/profile.jpg';
        this.profileData = {
          ...this.profileData,
